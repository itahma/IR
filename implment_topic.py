...
def readFileTopic(data_set):
    if data_set == 1:
        ...
        file_path = 'C:/Users/ASUS/.ir_datasets/beir/webis-touche2020/topic_weights.csv'
    elif data_set == 2:
        file_path = 'C:/Users/ASUS/.ir_datasets/clinicaltrials/trec-pm-2017/topic_weights.csv'
