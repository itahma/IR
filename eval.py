...
def get_id_from_text(text):
    with open(r'C:/Users/ASUS/.ir_datasets/beir/webis-touche2020/queries.jsonl', 'r') as file:
        for line in file:
...
def readQrels(query_number):
    data=[]
    i = 0
    with open(r'C:/Users/ASUS/.ir_datasets/beir/webis-touche2020/qrels/test.tsv', 'r') as file:
        for line in file:
