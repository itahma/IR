...
def get_query_indices(query):
    # Parse the XML file
    tree = ET.parse('C:/Users/ASUS/.ir_datasets/clinicaltrials/trec-pm-2017/queries.xml')
    root = tree.getroot()
...
def readQrle(query):
    with open('C:/Users/ASUS/.ir_datasets/clinicaltrials/trec-pm-2017/qrels', 'r') as file:
        print(query)
...
def eval2(query,predicted_documents):
    relevant_documents = []  
    data=readQrle(query)
    with open(r'C:/Users/ASUS/.ir_datasets/clinicaltrials/trec-pm-2017/qrels', 'r') as file:
        i=0   
        for line in file:
